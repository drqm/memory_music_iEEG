...
tasks = ["learningBachShort_iEEG_norwegian.py",
         "localizer_iEEG_norwegian.py",
         "manipulation_task_iEEG_norwegian.py"]
...
for tsk_ix, tsk in enumerate(task_order):
    ...
    if tsk_ix < len(task_order) - 1:
        ...
        wait_scr = visual.TextStim(win0, text = "Tid for en liten pause. Ta den tiden du trenger.\n"
                                                "Trykk en tast når du er klar for å fortsette.",
