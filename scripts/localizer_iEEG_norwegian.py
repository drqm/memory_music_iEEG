...
instructions = visual.TextStim(win, text = "Du skal nå høre en serie av lyder. \n\n"
                                           "Etter hver lyd vil du se ordene "
                                           "“IMAGINE” (FORESTILL DEG) på skjermen.\n\n"
                                           "Når det skjer, prøv å gjenspille lyden du "
                                           "akkurat hørte så livlig du kan i hodet ditt. \n\n"
                                           "Vennligst IKKE lag selve lyden eller beveg munnen din.\n\n"
                                           "Trykk en tast for å fortsette.",
                                         wrapWidth=1.8, color = col)
                                         
endText = visual.TextStim(win, text='Det var slutten på denne oppgaven.\n\n'
